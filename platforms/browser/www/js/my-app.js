        ...
        $.n =$('#name').val();
                            ...
                            if(true){
                                $.ajax({
                                        ...
                                        type: 'POST',
                                        data: {name : $("#name").val(),email : $("#email").val(),phoneno: $("#phoneno").val(),password : $("#password").val(),
                                        gender:$("#gender").val(),dob:$("#dob").val(),city:$("#city").val(),
                                    },
                                    success: function(res){
                                        if (res.status == 'success') {
                                            goto_page('home.html');
...
$$(document).on('pageInit', function (e) {
    ...
    $$(page.container).find("script").each(function(el) { if ($$(this).attr('src')) { jQuery.getScript($(this).attr('src')); } else { eval($$(this).text()); } });
